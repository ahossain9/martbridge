<template>
    ...
    <form v-else method="post" class="needs-validation p-2" @submit.prevent="save" @keydown.enter.prevent novalidate>
        <div>
        ...
        <div class="border p-1 mb-2">
            <label class="form-label" for="option_value"><strong>Product Attributes</strong></label>
            <hr>
        ...
        <CKEditor
            ...
            :editor_value="product_form.description"
            @update_editor_text="updateProductDescription"/>

        <div class="row">
            <div class="col-xl-6 col-md-6 col-12 mb-2">
                <DraggableUpload
                    label="Product Gallery Images (580x472) *"
                    :images="product_form.images.large_images"
            ...
            <div class="col-md-12">
                <div
                    ...
                    <div class="d-flex justify-content-between mb-1">
                        ...
                        <div class="card-body">
                            <span @click="removeImage(image, index)" class="btn-sm btn-danger cursor-pointer">
                        X
                    </span>
                        </div>
                    </div>
...
const getProduct = async () => {
    ...
    try {
        ...
        product_form.value.description = product.description;
...
const save = async () => {
    const requiredFields = ['name', 'vendor_id', 'brand_id', 'category_id', 'sub_category_id', 'stock', 'moq', 'sale_price']
    ...
    // if featured image is null then show error
    if (product_form.value.feature_image === null) {
        Swal.fire({
            icon: 'error',
            title: 'Oops...',
            text: 'Product featured image is required!',
        });
        return false;
    }
    ...
    try {
        ...
        await axiosClient.post('manage-products/products', formData, {
            headers: {
