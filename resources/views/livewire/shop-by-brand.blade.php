...
<div wire:ignore>
    @foreach($brands as $brand)
        <div wire:key="item-{{$brand->name}}" class="container furniture">
                    ...
                    <ul class="nav nav-pills nav-border-anim justify-content-center" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="furn-new-link" data-toggle="tab"
                               href="#{{ $brand->name }}-new-tab" role="tab" aria-controls="{{ $brand->name }}-new-tab"
            ...
            <div class="tab-content tab-content-carousel">
                <div class="tab-pane p-0 fade show active" id="{{ $brand->name }}-new-tab" role="tabpanel"
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                        ...
                        @foreach(ProductHelper::getProductsByBrandDesc($brand->id) as $product)
                            @php
                                $brandProductImg = $product->galleries->first()?->images?->large_image;
                            @endphp
                                    ...
                                    <figure class="product-media">
                                     <span
                                        ...
                                        <a href="{{ route('frontend.shop.product', $product->slug) }}">
                                            <img loading="lazy" src="{{ getImageUrl($brandProductImg) ?? '#' }}"
